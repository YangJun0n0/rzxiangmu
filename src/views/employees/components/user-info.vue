...
import { getPersonalDetail, saveEmployeesInfoAPI } from '@/api/employees'
...
export default {
  ...
  methods: {
    ...
    async loadEmployees() {
      ...
      this.formData = res // 获取员工数据
    },
    async saveEmployeesInfo() { // 下半部分
      try {
